"""
train.py – EfficientNetB0 + Transformer Image Captioning
Based on the Keras example: keras.io/examples/vision/image_captioning
Dataset: Flickr8k
"""
...
def train_val_split(caption_data, train_size=0.8, shuffle=True):
    ...
    training_data   = {img: caption_data[img] for img in all_images[:train_size]}
    validation_data = {img: caption_data[img] for img in all_images[train_size:]}
...
class LRSchedule(keras.optimizers.schedules.LearningRateSchedule):
    ...
    def __call__(self, step):
        ...
        warmup_lr        = self.post_warmup_learning_rate * warmup_progress
        return tf.cond(
...
if __name__ == "__main__":
    ...
    # Save vectorization vocab for inference
    ...
    callbacks = [
        ...
        keras.callbacks.ModelCheckpoint(
            "caption_model", save_best_only=True, save_format="tf")
    ]
    ...
    print("\n✅ Training complete. Model saved to 'caption_model' folder.")